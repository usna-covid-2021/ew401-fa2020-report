...
\hypersetup{
  pdfauthor={Nathan Dietrich, Alex Peralta, and Corwin Stites},
  pdftitle={Contagion Crushing Corporation and Partnership -- Medbot},
  pdfsubject={weapons, robotics, and control engineering},
  pdfkeywords={medical robotics, covid-19}
}
\coursenumber{EW401}
\student{MIDN 1/C N.~Dietrich, MIDN 1/C A.~Peralta, and MIDN 1/C C.~Stites}
\advisor{Assistant Professor D. Evangelista}
\contactinfo{\emph{m216468@usna.edu, m215262@usna.edu, m211500@usna.edu}}
...
\bibliography{IEEEabrv,references/covid.bib}
\end{document}